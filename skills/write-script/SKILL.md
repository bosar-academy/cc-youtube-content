...
Write publish-ready YouTube scripts for the {{CHANNEL_NAME}} channel (AI-First Framework niche). Produces a structured script with hooks, retention markers, B-roll cues, diagram cues, and a natural CTA bridge to {{YOUR_BUSINESS}}.
...
3. Research brief (if provided) — Competitor analysis, gaps, recommended angles
...
- **NOT copying {{COMPETITOR}}** — our term is "AI-First Framework", NOT "{{COMPETITOR_PRODUCT}}"
...
- Feel authentic to {{CHANNEL_NAME}}'s voice (not clickbait-y, but genuinely compelling)
...
[12:00 - 13:00] CTA — Subscribe + natural {{YOUR_BUSINESS}} bridge
```
...
| `[CTA]` | Call-to-action marker | `[CTA: Subscribe + {{YOUR_BUSINESS}} mention]` |
...
- The CTA to {{YOUR_BUSINESS}} must feel like a natural next step, never forced
...
[Natural bridge to {{YOUR_BUSINESS}} — "If you want to go deeper..."]
...
## {{YOUR_BUSINESS}} Bridge Templates

Use one of these natural transitions for the CTA (never sound salesy):

1. **The "Go Deeper" bridge**: "Everything I showed you today? That's just the surface. Inside {{YOUR_BUSINESS}}, we build the complete system from scratch — and you walk out with a working product you can sell."
2. **The "Shortcut" bridge**: "You could figure all of this out on your own — it took me months. Or you could join the next {{YOUR_BUSINESS}} cohort and have it built in 8 weeks."
3. **The "Proof" bridge**: "This is exactly what our {{YOUR_BUSINESS}} students build in Module [X]. If you want the full playbook, link's in the description."
4. **The "Community" bridge**: "The hardest part of going AI-first isn't the tech — it's doing it alone. That's why we built {{YOUR_BUSINESS}} as a cohort..."
